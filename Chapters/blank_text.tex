...
CubeSat reliability literature suggests increasing testing time (Faure et al. 2017) instead of subsystems redundancy to improve reliability (Bouwmeester, Menicucci, Gill, 2022b).
...
\begin{figure}
	\centering 
	\includegraphics[width=0.4\textwidth]{Images/Figure 5-38.png}	
